...
@implementation AppleAuthenticationMappings
...
{
  return @{
      @"namePrefix": nameComponents.namePrefix ? nameComponents.namePrefix : @"",
           @"givenName": nameComponents.givenName? nameComponents.givenName : @"",
           @"middleName": nameComponents.middleName? nameComponents.middleName : @"",
           @"familyName": nameComponents.familyName? nameComponents.familyName : @"",
           @"nameSuffix": nameComponents.nameSuffix? nameComponents.nameSuffix : @"",
           @"nickname": nameComponents.nickname? nameComponents.nickname : @""
           };
}
